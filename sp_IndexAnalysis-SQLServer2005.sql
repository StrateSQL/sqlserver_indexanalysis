...
----------------------------------------------------------------------------------------------
2012-12-10		9.01	    Rewrote information collection to reduce dynamic SQL
                            * Fixed issue with Object_ID
                            * Added unique check to duplication and 
                              overlapping indexes
...
2012-12-28      9.02       * Fixed new issues WITH Object_ID
...
2013-01-08      9.03       * Improved error handling to solve issue with truncation MESSAGE
2013-03-07		9.04		* Fixed duplicate index logic to match that from 
...
2013-03-20		9.05		* Fixed data type on missing_index_impact (Credit: Dick Baker)
2013-05-22      9.06       * Fixed bug causing mismatch with foreign key analysis
