...
----------------------------------------------------------------------------------------------
2012-12-10		10.01	    Rewrote information collection to reduce dynamic SQL
...
2012-12-28      10.02       * Fixed new issues WITH Object_ID
...
2013-01-08      10.03       * Fixed issue with overlapping indexes and duplicate indexes related
                            filtered indexes
                            * Improved error handling to solve issue with truncation MESSAGE
2013-03-07		10.04		* Fixed duplicate index logic to match that from 
...
2013-03-20		10.05		* Fixed data type on missing_index_impact (Credit: Dick Baker)
2013-05-22      10.06       * Fixed bug causing mismatch with foreign key analysis
